...
{else}
  ...
  {elseif $action eq 131072}
    <fieldset><legend>{ts}Refund Information{/ts}</legend>
          <table class="form-layout-compressed">
            ...
            <tr id="refundAmount">
              <td class="label" style="vertical-align: top;">{$form.refund_amount.label}</td>
              <td><span id='refundAmount'>{$form.currency.html|crmAddClass:eight}&nbsp;{$form.total_amount.html|crmAddClass:eight}</span>
