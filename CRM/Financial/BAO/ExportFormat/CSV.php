  ...
  public function makeExport($export) {
    ...
    foreach ($export as $batchId => $dao) {
      ...
      while ($dao->fetch()) {
        ...
        $debitAccountName = $debitAccountType = $debitAccount = NULL;
        ...
        if ($dao->to_account_name) {
          $debitAccountName = $dao->to_account_name;
          $debitAccountType = $dao->to_account_type_code;
          $debitAccount = $dao->to_account_code;
        }
        else {
          $debitAccountName = $dao->from_credit_account_name;
          $debitAccountType = $dao->from_credit_account_type_code;
          $debitAccount = $dao->from_credit_account;
        }
        ...
        $financialItems[] = array(
          ...
          'Debit Account Type' => $debitAccountType,
